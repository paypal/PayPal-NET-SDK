...
{
    public partial class PaymentWithPayPalWithMultipleItems : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // ### List<Item>
                // ### Create a new ItemList to contain the list of items to be included in this transaction
                ItemList item_list = new PayPal.Api.Payments.ItemList();
                ...
                Item Item2 = new Item();
                Item2.currency = "USD";
                Item2.name = "Example Item 2";
                Item2.price = "30";
                Item2.quantity = "1";
                Item2.sku = "123456";
             
                // Add the Items to the ItemList
                item_list.items.Add(Item1);
                item_list.items.Add(Item2);
